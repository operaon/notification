# Contrato do módulo — notification

Este documento resume o contrato local de notification. O contrato transversal de headers e webhooks está em [communication-contract.md](communication-contract.md).
